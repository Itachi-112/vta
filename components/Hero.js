...
export default function HeroSection() {
  ...
  return (
    <section className="relative h-[90vh] min-h-[420px] w-full bg-transparent">
      {/* Transparent background so global SVG remains visible */}

      <div className="relative z-10 flex flex-col items-center justify-center h-full px-4 text-white">
        <div className="glass p-6 sm:p-8 rounded-xl max-w-3xl text-center">
          <TypewriterEffect words={words} className="text-lg sm:text-2xl md:text-4xl lg:text-5xl" />

          <Reveal delay={60}>
            <p className="mt-4 text-base sm:text-lg md:text-xl text-gray-800 dark:text-gray-200 max-w-md sm:max-w-2xl mx-auto">
          ...
          <div className="mt-6 sm:mt-8">
            <Reveal animation="fade-up" delay={120}>
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-2 sm:gap-3 bg-blue-500 hover:bg-blue-400 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-full shadow-lg text-base sm:text-lg transition-transform duration-300"
              >
